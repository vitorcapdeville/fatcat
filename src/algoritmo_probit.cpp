...
// Aprender a usar header pra esse tipo de funcao, q pode ser usada em varios lugares
...
arma::mat passo_beta(int it, int j, int p, arma::mat aux4, double sdpropbeta, double sdpropbeta2, arma::mat f, arma::mat alfa, arma::colvec sigma2, arma::mat y){
  arma::mat auxlb(j,p);
  double A1 = 0.0;
  double A2 = 0.0;
  double A = 0.0;
...
arma::colvec passo_sigma2(int it, int j, arma::colvec aux3, double sdpropsigma2, arma::mat beta, arma::mat f, arma::mat alfa,arma::mat y){
...
arma::mat passo_f(int it, int n, int p, arma::mat aux5, double sdpropf, arma::mat beta, arma::colvec sigma2, arma::mat alfa, arma::mat y){
  arma::colvec aux6(p);
  arma::colvec fprop;
  double A1 = 0.0;
  double A2 = 0.0;
...
List algoritmo_probit(arma::mat y, int nit, arma::cube beta, arma::mat sigma2, arma::cube f, arma::mat alfa, double sdpropbeta, double sdpropbeta2, double sdpropf, double sdpropsigma2, int n, int p, int j,bool display_progress = true){
  ...
  for(int it=1; it <= nit-1;it++){
    ...
    beta.slice(it) = passo_beta(it, j, p, beta.slice(it-1), sdpropbeta, sdpropbeta2, f.slice(it-1), alfa, sigma2.col(it-1), y);

    sigma2.col(it) = passo_sigma2(it, j, sigma2.col(it-1), sdpropsigma2 , beta.slice(it), f.slice(it-1), alfa, y);

    f.slice(it) = passo_f(it, n, p, f.slice(it-1), sdpropf, beta.slice(it), sigma2.col(it), alfa, y);
  }
...
// Funcoes auxiliares para testar
// List testeBeta(arma::mat y, int nit, arma::cube beta, arma::colvec sigma2, arma::mat f, arma::mat alfa, double sdpropbeta, double sdpropbeta2, double sdpropf, double sdpropsigma2, int n, int p, int j){
//
//   for(int it=1; it <= nit-1;it++){
//
//     beta.slice(it) = passo_beta(it, j, p, beta.slice(it-1), sdpropbeta, sdpropbeta2, f, alfa, sigma2, y);
//
//   }
...
// }
//
// List testeSigma(arma::mat y, int nit, arma::mat beta, arma::mat sigma2, arma::mat f, arma::mat alfa, double sdpropbeta, double sdpropbeta2, double sdpropf, double sdpropsigma2, int n, int p, int j){
//
//   for(int it=1; it <= nit-1;it++){
//
//     sigma2.col(it) = passo_sigma2(it, j, sigma2.col(it-1), sdpropsigma2 , beta, f, alfa, y);
//
//   }
//   List res = List::create(_["sigma2"] = sigma2);
//   return res;
// }
//
// List testeF(arma::mat y, int nit, arma::mat beta, arma::colvec sigma2, arma::cube f, arma::mat alfa, double sdpropbeta, double sdpropbeta2, double sdpropf, double sdpropsigma2, int n, int p, int j){
//
//   for(int it=1; it <= nit-1;it++){
//
//     f.slice(it) = passo_f(it, n, p, f.slice(it-1), sdpropf, beta, sigma2, alfa, y);
//
//   }
//   List res = List::create(_["f"] = f);
//   return res;
// }
